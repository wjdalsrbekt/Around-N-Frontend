...
export default {
  ...
  methods: {
    ...
    searchPlaces() {
      ...
      this.ps.categorySearch(this.currCategory, this.placeSearchCB);
      //this.ps.categorySearch(this.currCategory, this.placeSearchCB, { userMapBounds: true });
    },
    placeSearchCB(data, status) {
      ...
      //else if(e.status === kakao.maps.services.Status.ZERO_RESULT){
      //}
      //else if(e.status === kakao.maps.services.Status.ERROR){
      //}
    },
    displayPlaces(places) {
      //var order = document.getElementById(currCategory).getAttribute('data-order');
      var order = this.currCategory.getAttribute('data-order');
    ...
    displayPlaceInfo(place) {
      ...
      this.lengthplaceOverlay.setPosition(new kakao.maps.LatLng(place.y, place.x));
